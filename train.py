...
def main():
    ...
    group.add_argument('--cfg',   help='Base config (default: auto)', choices=['usb128_1', 'usb128_2', 'usb64_1', 'auto', 'auto_map8', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline'])
