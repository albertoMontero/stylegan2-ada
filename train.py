...
def setup_training_options(
    ...
    cfg_specs = {
        'usb128_1':      dict(ref_gpus=1,  kimg=25000,  mb=32, mbstd=4,  fmaps=0.5, lrate=0.002,  gamma=0.16, ema=10,  ramp=None, map=8),
        'usb128_2':      dict(ref_gpus=1,  kimg=25000,  mb=32, mbstd=4,  fmaps=0.5, lrate=0.0025, gamma=0.08, ema=10,  ramp=None, map=8),
        'usb128_3':      dict(ref_gpus=1,  kimg=25000,  mb=32, mbstd=4,  fmaps=0.5, lrate=0.001,  gamma=0.24, ema=10, ramp=None, map=8),
        'usb64_1':       dict(ref_gpus=1,  kimg=25000,  mb=16, mbstd=4,  fmaps=0.5, lrate=0.0025, gamma=0.16, ema=10,  ramp=None, map=8),
        ...
        'auto_map8':     dict(ref_gpus=-1, kimg=25000,  mb=-1, mbstd=-1, fmaps=-1,  lrate=-1,     gamma=-1,   ema=-1,  ramp=None, map=8),
...
def main():
    ...
    group.add_argument('--cfg',   help='Base config (default: auto)', choices=['usb128_1', 'usb128_2', 'usb128_3', 'usb64_1', 'auto', 'auto_map8', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline'])
